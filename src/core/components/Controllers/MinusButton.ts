...
export default class MinusButton {
    ...
    constructor(app: PIXI.Application, container: PIXI.Container, playbutton: PlayButton) {
        ...
        this.app = app;
        this.texture = this.app.loader.resources!.controllers.textures!['icon_minu.png'];
    ...
    private init() {
        ...
        this.sprite.position.x = this.playbutton.sprite2.position.x + 11;
